...
import 'package:wintershopping/animation/FadeAnimation.dart';
import 'package:wintershopping/models/product.dart';
import 'package:wintershopping/pages/payment.dart';
import 'package:wintershopping/pages/product_view.dart';
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(product.brand, style: TextStyle(color: Colors.deepOrangeAccent, fontSize: 14,),),
                    SizedBox(height: 5,),
                    Text(product.name,
                      style: TextStyle(
                        fontSize: 18,
