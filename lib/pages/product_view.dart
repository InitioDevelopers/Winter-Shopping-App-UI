                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text(widget.product.brand, style: TextStyle(color: Colors.deepOrangeAccent, fontSize: 14,),),
                          ],
                        ),
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              margin: EdgeInsets.only(right: 10),
                              decoration: BoxDecoration(
                                color: _selectedSize == index ? Colors.deepOrangeAccent : Colors.grey.shade200,
                                shape: BoxShape.circle
                              ),
                              width: 40,
                              height: 40,
